        ...
        <Container>
          ...
          <div className="max-w-2xl mx-auto flex flex-col gap-4">
            {whyChoosePoints.map((p, idx) => (
              <Card key={idx} className="p-4 border border-slate-100 bg-white rounded-xl shadow-soft hover:shadow-medium transition-all duration-300 flex items-start gap-3 text-left">
